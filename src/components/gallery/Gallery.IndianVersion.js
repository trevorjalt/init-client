...
//Example Function for getting images
getPhotos(page) {
  this.setState({ loading: true });
  //example uses axios, need to refactor to use our services functions
  axios
    //notice the ${} for our page parameter
    .get(
      `https//genericendpoint.com/photos?_page=${page}&_limit=10`
    )
    .then(res => {
...
//We gon want get our photos when this component shows up
componentDidMount() {
  this.getPhotos(this.state.page);

  //Honestly, I don't have the ability to articulate what is happening here
  let options = {
    root: null,
    rootMargin: '0px',
    threshold: 1.0
  ...
  //Yeah, like I said, wtf. Gonna have to do some research
...
//This is something related to changes on the scroll.
//Essentially, when this observer notices we have reached our nadir we will summon the next 'page'
//In this case, our next page will be 9 Akira Toriyama Characters
